...
(function() {
  ...
  CelestialBody.Moho = Moho = new CelestialBody(3.3022e+23, 2439700, 5067031.68, new Orbit(Kerbol, 57908973645.88802, 0.2056187266319207, 28.60252108855048, 10.86541167564728, 66.90371044151551, 5.553921));

  CelestialBody.Eve = Eve = new CelestialBody(4.8676e+24, 6051800, 20996798.4, new Orbit(Kerbol, 108209548790.4671, 0.006810339650842032, 24.46397633556437, 7.981603378781639, 123.7121294282329, 5.4322674), 90.1);

  CelestialBody.Kerbin = Kerbin = new CelestialBody(5.97258013078e+24, 6371000, 86164.098903691, new Orbit(Kerbol, 149494366257.0978, 0.01609636160505683, 23.44603795469773, 359.9965004168758, 102.9720683296131, 6.23188565452), 1);

  CelestialBody.Mun = Mun = new CelestialBody(7.346295386e+22, 1737100, 2360584.68479999, new Orbit(Kerbin, 384308437.7707066, 0.05328149353682574, 28.36267790798491, 2.296616161126016, 199.7640930160823, 3.88686980063));

  CelestialBody.Duna = Duna = new CelestialBody(6.4185e+23, 3396200, 88642.6848, new Orbit(Kerbol, 227949699961.9763, 0.09326110278323557, 24.69272426910055, 3.351911063089117, 332.1022655295414, 2.95643613254), 0.0069);
  ...
  CelestialBody.Jool = Jool = new CelestialBody(1.8986E+27, 69911000, 35730, new Orbit(Kerbol, 778188938659.7554, 0.04872660654702194, 23.25313306947884, 3.262077289923354, 10.75642751202877, 5.28103888595), 15);
  ...
  CelestialBody.Sentar = Sentar = new CelestialBody(5.68356253671e+26, 60268000, 38052, new Orbit(Kerbol, 1424838758613.269, 0.05347166506749872, 22.56992281132335, 5.970845343832233, 85.04661202834268, 1.1775536145636778), 20);
  ...
  CelestialBody.Skelton = Skelton = new CelestialBody(8.681E+25, 25559000, 62063.712, new Orbit(Kerbol, 2866832853163.975, 0.04620653158718433, 23.67256993343676, 1.846089669223938, 169.6876790522249, 5.006070925851672), 50);
  ...
  CelestialBody.Laythe = Laythe = new CelestialBody(1.0243E+26, 24764000, 57996, new Orbit(Kerbol, 4497455831858.165, 0.008090397956671817, 22.30735942219246, 3.512610707556779, 29.81485499342245, 2.829170814718441), 15);
  ...
  CelestialBody.Dres = Dres = new CelestialBody(1.305e+22, 1153000, 551856.672, new Orbit(Kerbol, 5845670624078.223, 0.2462772488425983, 23.61236405752844, 44.36099836994975, 184.4945352163909, 5.238251980021541));
